...
The SRAM cycle to collect valuable data for PUF analysis is in figure :numref:`sram_cycle`.

.. _sram_platform:

.. figure:: ./SRAM_Platform.jpg
   :alt: SRAM Platform

   SRAM Reliability Platform in TIMA Laboratory.


.. _sram_cycle:

.. figure:: ./SRAM_Testing_Pipeline.png
   :alt: Small chain of STM32 micro-controllers.
   :width: 30%
   :align: right
...
An SRAM Station has been deployed at TIMA Laboratory in Grenoble, France. The data gathered in this station is publicly available online through the following `website <https://puf4iot.univ-grenoble-alpes.fr>`_
...
#. Setup: Guide on how to install the necesary software as well as the physical installation of the devices.

#. Usage: Description on the hardware and software parts of the station.

    #. Description of the communication protocol.

    #. Example on the usage of the python modules.

#. API Documentation: Documentation and access to the source code.
